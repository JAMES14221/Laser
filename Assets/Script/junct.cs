...
public class junct : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (zRotation == 0)
        {
            gridarray.Instance.grid[grid_y, grid_x] = "134";
        }
        else if (zRotation == 270)
        {
            gridarray.Instance.grid[grid_y, grid_x] = "124";
        }
        else if (zRotation == 180)
        {
            gridarray.Instance.grid[grid_y, grid_x] = "123";
        }
        else if (zRotation == 90)
        {
            gridarray.Instance.grid[grid_y, grid_x] = "234";
        }

        //SETTING ACTIVE STATEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE
